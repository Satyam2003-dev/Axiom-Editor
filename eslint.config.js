...
export default tseslint.config(
	...
	// All files (JS and TS)
	{
		...
		rules: {
			...
			'local/code-no-dangerous-type-assertions': 'off', // Axiom warn -> off
			...
			// Axiom - this should only apply to workbench/axiom/
			// 'header/header': [
			// 	2,
			// 	'block',
			// 	[
	...
	// TS
	{
		...
		rules: {
			'@stylistic/ts/semi': 'off', // <-- Axiom
			'@stylistic/ts/member-delimiter-style': 'off', // <-- Axiom
			...
			'jsdoc/no-types': 'warn',
			'local/code-no-static-self-ref': 'off' // <-- Axiom
		}
	},
	// vscode TS
	{
