...
import { MCPChannel } from '../../workbench/contrib/axiom/electron-main/mcpChannel.js';
/**
...
export class CodeApplication extends Disposable {
	...
	private initChannels(accessor: ServicesAccessor, mainProcessElectronServer: ElectronIPCServer, sharedProcessClient: Promise<MessagePortClient>): void {
		...
		// Axiom - use loggerChannel as reference
		const metricsChannel = ProxyChannel.fromService(accessor.get(IMetricsService), disposables);
		mainProcessElectronServer.registerChannel('axiom-channel-metrics', metricsChannel);
		...
		// Axiom added this
		const axiomSCMChannel = ProxyChannel.fromService(accessor.get(IAxiomSCMService), disposables);
		mainProcessElectronServer.registerChannel('axiom-channel-scm', axiomSCMChannel);

		// Axiom added this
		const mcpChannel = new MCPChannel();
		mainProcessElectronServer.registerChannel('axiom-channel-mcp', mcpChannel);
