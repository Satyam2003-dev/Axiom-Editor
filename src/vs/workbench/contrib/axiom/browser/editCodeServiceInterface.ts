...
import { Diff, DiffArea, AxiomFileSnapshot } from '../common/editCodeServiceTypes.js';
...
export interface IEditCodeService {
	...
	// testDiffs(): void;
	getAxiomFileSnapshot(uri: URI): AxiomFileSnapshot;
	restoreAxiomFileSnapshot(uri: URI, snapshot: AxiomFileSnapshot): void;
}
