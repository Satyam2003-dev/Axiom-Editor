...
import { TextAreaFns, AxiomInputBox2 } from '../util/inputs.js';
import { QuickEditPropsType } from '../../../quickEditActions.js';
import { ButtonStop, ButtonSubmit, IconX, AxiomChatArea } from '../sidebar-tsx/SidebarChat.js';
import { AXIOM_CTRL_K_ACTION_ID } from '../../../actionIDs.js';
import { useRefState } from '../util/helpers.js';
import { isFeatureNameDisabled } from '../../../../../../../workbench/contrib/axiom/common/axiomSettingsTypes.js';
...
export const QuickEditChat = ({
	...
	const loadingIcon = <div
		className="@@codicon @@codicon-loading @@codicon-modifier-spin @@codicon-no-default-spin text-axiom-fg-3"
	/>
	...
	const keybindingString = accessor.get('IKeybindingService').lookupKeybinding(AXIOM_CTRL_K_ACTION_ID)?.getLabel()
