...
import { MCPUserState, RefreshableProviderName, SettingsOfProvider } from '../../../../../../../workbench/contrib/axiom/common/axiomSettingsTypes.js'
import { DisposableStore, IDisposable } from '../../../../../../../base/common/lifecycle.js'
import { AxiomSettingsState } from '../../../../../../../workbench/contrib/axiom/common/axiomSettingsService.js'
import { ColorScheme } from '../../../../../../../platform/theme/common/theme.js'
import { RefreshModelStateOfProvider } from '../../../../../../../workbench/contrib/axiom/common/refreshModelService.js'
...
let settingsState: AxiomSettingsState
const settingsStateListeners: Set<(s: AxiomSettingsState) => void> = new Set()
...
export const _registerServices = (accessor: ServicesAccessor) => {
	...
	const stateServices = {
		...
		settingsStateService: accessor.get(IAxiomSettingsService),
		refreshModelService: accessor.get(IRefreshModelService),
		themeService: accessor.get(IThemeService),
		editCodeService: accessor.get(IEditCodeService),
		axiomCommandBarService: accessor.get(IAxiomCommandBarService),
		modelService: accessor.get(IModelService),
		mcpService: accessor.get(IMCPService),
	}

	const { settingsStateService, chatThreadsStateService, refreshModelService, themeService, editCodeService, axiomCommandBarService, modelService, mcpService } = stateServices
	...
	disposables.push(
		axiomCommandBarService.onDidChangeState(({ uri }) => {
			commandBarURIStateListeners.forEach(l => l(uri));
		})
	)

	disposables.push(
		axiomCommandBarService.onDidChangeActiveURI(({ uri }) => {
...
const getReactAccessor = (accessor: ServicesAccessor) => {
	const reactAccessor = {
		...
		IAxiomModelService: accessor.get(IAxiomModelService),
		IWorkspaceContextService: accessor.get(IWorkspaceContextService),

		IAxiomCommandBarService: accessor.get(IAxiomCommandBarService),
...
export const useAccessor = () => {
	if (!reactAccessor_) {
		throw new Error(`⚠️ Axiom useAccessor was called before _registerServices!`)
	}
