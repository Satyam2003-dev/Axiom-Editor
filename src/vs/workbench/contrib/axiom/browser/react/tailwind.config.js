	...
	theme: {
		extend: {
			typography: theme => ({
				DEFAULT: {
					css: {
						'--tw-prose-body': 'var(--axiom-fg-1)',
						'--tw-prose-headings': 'var(--axiom-fg-1)',
						'--tw-prose-lead': 'var(--axiom-fg-2)',
						'--tw-prose-links': 'var(--axiom-link-color)',
						'--tw-prose-bold': 'var(--axiom-fg-1)',
						'--tw-prose-counters': 'var(--axiom-fg-3)',
						'--tw-prose-bullets': 'var(--axiom-fg-3)',
						'--tw-prose-hr': 'var(--axiom-border-4)',
						'--tw-prose-quotes': 'var(--axiom-fg-1)',
						'--tw-prose-quote-borders': 'var(--axiom-border-2)',
						'--tw-prose-captions': 'var(--axiom-fg-3)',
						'--tw-prose-code': 'var(--axiom-fg-0)',
						'--tw-prose-pre-code': 'var(--axiom-fg-0)',
						'--tw-prose-pre-bg': 'var(--axiom-bg-1)',
						'--tw-prose-th-borders': 'var(--axiom-border-4)',
						'--tw-prose-td-borders': 'var(--axiom-border-4)',
					},
				},
			}),
			fontSize: {
			...
			colors: {
				'axiom-bg-1': 'var(--axiom-bg-1)',
				'axiom-bg-1-alt': 'var(--axiom-bg-1-alt)',
				'axiom-bg-2': 'var(--axiom-bg-2)',
				'axiom-bg-2-alt': 'var(--axiom-bg-2-alt)',
				'axiom-bg-2-hover': 'var(--axiom-bg-2-hover)',
				'axiom-bg-3': 'var(--axiom-bg-3)',


				'axiom-fg-0': 'var(--axiom-fg-0)',
				'axiom-fg-1': 'var(--axiom-fg-1)',
				'axiom-fg-2': 'var(--axiom-fg-2)',
				'axiom-fg-3': 'var(--axiom-fg-3)',
				// 'axiom-fg-4': 'var(--vscode-tab-inactiveForeground)',
				'axiom-fg-4': 'var(--axiom-fg-4)',

				'axiom-warning': 'var(--axiom-warning)',

				'axiom-border-1': 'var(--axiom-border-1)',
				'axiom-border-2': 'var(--axiom-border-2)',
				'axiom-border-3': 'var(--axiom-border-3)',
				'axiom-border-4': 'var(--axiom-border-4)',

				'axiom-ring-color': 'var(--axiom-ring-color)',
				'axiom-link-color': 'var(--axiom-link-color)',
