...
export interface IAxiomModelService {
	readonly _serviceBrand: undefined;
	initializeModel(uri: URI): Promise<void>;
	getModel(uri: URI): AxiomModelType;
	getModelFromFsPath(fsPath: string): AxiomModelType;
	getModelSafe(uri: URI): Promise<AxiomModelType>;
	saveModel(uri: URI): Promise<void>;

}

export const IAxiomModelService = createDecorator<IAxiomModelService>('axiomAxiomModelService');

class AxiomModelService extends Disposable implements IAxiomModelService {
	_serviceBrand: undefined;
	static readonly ID = 'axiomAxiomModelService';
	...
	getModelSafe = async (uri: URI): Promise<AxiomModelType> => {
...
registerSingleton(IAxiomModelService, AxiomModelService, InstantiationType.Eager);
