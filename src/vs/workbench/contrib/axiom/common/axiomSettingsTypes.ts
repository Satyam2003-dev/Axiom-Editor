...
import { AxiomSettingsState } from './axiomSettingsService.js'
...
export type AxiomStatefulModelInfo = { // <-- STATEFUL
	modelName: string,
...
export const subTextMdOfProviderName = (providerName: ProviderName): string => {
	...
	if (providerName === 'googleVertex') return 'You must authenticate before using Vertex with Axiom. Read more about endpoints [here](https://cloud.google.com/vertex-ai/generative-ai/docs/multimodal/call-vertex-using-openai-library), and regions [here](https://cloud.google.com/vertex-ai/docs/general/locations#available-regions).'
...
const modelInfoOfDefaultModelNames = (defaultModelNames: string[]): { models: AxiomStatefulModelInfo[] } => {
	return {
...
export const isProviderNameDisabled = (providerName: ProviderName, settingsState: AxiomSettingsState) => {
...
export const isFeatureNameDisabled = (featureName: FeatureName, settingsState: AxiomSettingsState) => {
