...
// gets converted to --vscode-axiom-greenBG, see axiom.css, asCssVariable
registerColor('axiom.greenBG', configOfBG(acceptBG), '', true);
registerColor('axiom.redBG', configOfBG(rejectBG), '', true);
registerColor('axiom.sweepBG', configOfBG(sweepBG), '', true);
registerColor('axiom.highlightBG', configOfBG(highlightBG), '', true);
registerColor('axiom.sweepIdxBG', configOfBG(sweepIdxBG), '', true);
