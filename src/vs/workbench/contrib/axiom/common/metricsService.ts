...
export class MetricsService implements IMetricsService {
	...
	constructor(
		...
		this.metricsService = ProxyChannel.toService<IMetricsService>(mainProcessService.getChannel('axiom-channel-metrics'));
	}
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: 'axiomDebugInfo',
			f1: true,
			title: localize2('axiomMetricsDebug', 'Axiom: Log Debug Info'),
		});
	}
