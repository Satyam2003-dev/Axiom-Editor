...
import { FeatureName, ModelSelectionOptions, OverridesOfModel, ProviderName } from './axiomSettingsTypes.js';
...
export type AxiomStaticModelInfo = { // not stateful
	// Axiom uses the information below to know how to handle each model.
...
type AxiomStaticProviderInfo = { // doesn't change (not stateful)
	...
	modelOptions: { [key: string]: AxiomStaticModelInfo };
	modelOptionsFallback: (modelName: string, fallbackKnownValues?: Partial<AxiomStaticModelInfo>) => (AxiomStaticModelInfo & { modelName: string, recognizedModelName: string }) | null;
}
...
const defaultModelOptions = {
	...
	supportsFIM: false,
	reasoningCapabilities: false,
} as const satisfies AxiomStaticModelInfo
...
} as const satisfies { [s: string]: Partial<AxiomStaticModelInfo> }




// keep modelName, but use the fallback's defaults
const extensiveModelOptionsFallback: AxiomStaticProviderInfo['modelOptionsFallback'] = (modelName, fallbackKnownValues) => {

	const lower = modelName.toLowerCase()

	const toFallback = <T extends { [s: string]: Omit<AxiomStaticModelInfo, 'cost' | 'downloadable'> },>(obj: T, recognizedModelName: string & keyof T)
		: AxiomStaticModelInfo & { modelName: string, recognizedModelName: string } => {
...
} as const satisfies { [s: string]: AxiomStaticModelInfo }

const anthropicSettings: AxiomStaticProviderInfo = {
...
const openAISettings: AxiomStaticProviderInfo = {
...
const xAISettings: AxiomStaticProviderInfo = {
...
const geminiSettings: AxiomStaticProviderInfo = {
...
const deepseekSettings: AxiomStaticProviderInfo = {
...
const mistralSettings: AxiomStaticProviderInfo = {
...
const groqSettings: AxiomStaticProviderInfo = {
...
} as const satisfies Record<string, AxiomStaticModelInfo>
const googleVertexSettings: AxiomStaticProviderInfo = {
...
const microsoftAzureSettings: AxiomStaticProviderInfo = {
...
const awsBedrockSettings: AxiomStaticProviderInfo = {
...
const vLLMSettings: AxiomStaticProviderInfo = {
...
const lmStudioSettings: AxiomStaticProviderInfo = {
...
const ollamaSettings: AxiomStaticProviderInfo = {
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
...
const liteLLMSettings: AxiomStaticProviderInfo = { // https://docs.litellm.ai/docs/reasoning_content
	modelOptionsFallback: (modelName) => extensiveModelOptionsFallback(modelName, { downloadable: { sizeGb: 'not-known' } }),
	modelOptions: {},
	providerReasoningIOSettings: {
		input: { includeInPayload: openAICompatIncludeInPayloadReasoning },
...
const openRouterSettings: AxiomStaticProviderInfo = {
...
const modelSettingsOfProvider: { [providerName in ProviderName]: AxiomStaticProviderInfo } = {
