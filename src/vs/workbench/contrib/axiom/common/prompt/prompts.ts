...
import { ChatMode } from '../axiomSettingsTypes.js';
...
export const axiomPrefixAndSuffix = ({ fullFileStr, startLine, endLine }: { fullFileStr: string, startLine: number, endLine: number }) => {
...
// export const aiRegex_computeReplacementsForFile_userMessage = async ({ searchClause, replaceClause, fileURI, axiomFileService }: { searchClause: string, replaceClause: string, fileURI: URI, axiomFileService: IAxiomFileService }) => {

// 	// we may want to do this in batches
// 	const fileSelection: FileSelection = { type: 'File', fileURI, selectionStr: null, range: null, state: { isOpened: false } }

// 	const file = await stringifyFileSelections([fileSelection], axiomFileService)
