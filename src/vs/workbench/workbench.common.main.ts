...
//#region --- Axiom
import './contrib/axiom/browser/axiom.contribution.js'; // Axiom added this
//#endregion
...
// Chat
// Axiom - this is still registered to avoid console errors, we just commented it out in chatParticipant.contribution.ts
